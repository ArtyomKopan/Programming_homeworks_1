...
/*
void printValue(Value value, FILE* outputFile)
{
    switch (value.type) {
    case INT_TYPE:
        fprintf(outputFile, "%i", getInt(value));
    case DOUBLE_TYPE:
        fprintf(outputFile, "%lf", getDouble(value));
    case STRING_TYPE:
        fprintf(outputFile, "%s", getString(value));
    case POINTER_TYPE:
        fprintf(outputFile, "%i", getPointer(value));
    case NONE_TYPE:
